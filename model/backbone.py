...
def build_model_vit_base(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("vit_base_patch16_224", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_vit_large(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("vit_large_patch16_224", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_vit_huge(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("vit_huge_patch14_224", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_deit_base(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("deit_base_patch16_224", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_deit_small(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("deit_small_patch16_224", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_deit_tiny(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("deit_tiny_patch16_224", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_convnext_small(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("convnext_small", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_convnext_base(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("convnext_base", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_convnext_large(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("convnext_large", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_convnext_xlarge(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("convnext_xlarge", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_swin_tiny(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("swin_tiny_patch4_window7_224", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_swin_small(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("swin_small_patch4_window7_224", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_swin_base(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("swin_base_patch4_window7_224", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_swin_large(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("swin_large_patch4_window7_224", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_swin_v2_tiny(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("swinv2_tiny_window8_256", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_swin_v2_small(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("swinv2_small_window8_256", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_swin_v2_base(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("swinv2_base_window8_256", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_swin_v2_large(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("swinv2_large_window12_192_22k", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_efficientnetv2_s(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("efficientnetv2_s", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_efficientnetv2_m(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("efficientnetv2_m", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
...
def build_model_efficientnetv2_l(num_classes: int, pretrained: bool = False):
    if num_classes > 0:
        ...
        model = timm.create_model("efficientnetv2_l", pretrained=pretrained, num_classes=0, global_pool="avg")
    return model
